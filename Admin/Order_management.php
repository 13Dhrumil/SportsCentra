<html>
    ...
    <body>
        <center>
            <h1 class = "h1 mt-5">Order Management</h1>
            <form>
                <table>
                    <tr class = "all_css">
                        <td>Order Date : </td> <td><input type = "date"></td>
                    </tr>

                    <tr class = "all_css">
                        <td>Order Time : </td> <td><input type = "time"></td>
                    </tr>

                    <tr class = "all_css">
                        <td>Order Number : </td> <td><input type = "text"></td>
                    </tr>
                ...
                <br>
                <button type="button" class="btn btn-dark all_css">Approved</button>
