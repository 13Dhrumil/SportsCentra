...
<html>
    <head>
        <title>S.S Cricket Kit Page</title>
        ...
        <div class="container">
            <div class="row cards">
                <div class="col-4">
                    <div class="card">
                        <a href = "">
                            <img src="../Image/ss1.jpg" class="card-img-top cardd" alt="...">
                        </a>
                        <div class="card-body">
                            <p class="p">Ss Logo</p>
                ...
                <div class="col-4">
                    <div class="card">
                        <a href = "">
                            <img src="../Image/ss.jpg" class="card-img-top cardd" alt="...">
                        </a>
                        <div class="card-body">
                            <p class="p">Ss Cricket Kit</p>
                ...
                <div class="col-4">
                    <div class="card">
                        <a href = "">
                            <img src="../Image/ss2.jpg" class="card-img-top cardd" alt="...">
                        </a>
                        <div class="card-body">
                            <p class="p">Ss Bat</p>
